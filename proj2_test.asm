...
free(void *ap)
{
 ...
 d2a:	39 45 fc             	cmp    %eax,-0x4(%ebp)
 d2d:	72 24                	jb     d53 <free+0x4f>
 ...
 d44:	39 45 fc             	cmp    %eax,-0x4(%ebp)
 d47:	73 d4                	jae    d1d <free+0x19>
...
malloc(uint nbytes)
{
 ...
 e9a:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 e9d:	72 4d                	jb     eec <malloc+0xa6>
      if(p->s.size == nunits)
