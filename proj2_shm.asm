...
free(void *ap)
{
 ...
 b7e:	39 45 fc             	cmp    %eax,-0x4(%ebp)
 b81:	72 24                	jb     ba7 <free+0x4f>
 ...
 b98:	39 45 fc             	cmp    %eax,-0x4(%ebp)
 b9b:	73 d4                	jae    b71 <free+0x19>
